...
best_features = [7, 15, 19, 1, 23, 16, 63, 22, 30, 6, 2, 31, 54, 62, 4, 55, 27, 11, 17, 26, 67, 10, 35, 47, 51, 24, 20,
                 8, 48, 34, 59, 66, 49, 58, 52, 32]
...
class checkStyleMethods(featureExtractorBase.FeatureExtractorBase):
    ...
    def get_attributes(self):
        all = [("NCSS", "NUMERIC"), ("FileLen", "NUMERIC"), ("sum_fors", "NUMERIC"), ("sum_ifs", "NUMERIC"),
               ("sum_tries", "NUMERIC"),
               ...
               ("len_JavaNCSSmet", "NUMERIC"), ("sum_JavaNCSSmet", "NUMERIC"), ("mean_JavaNCSSmet", "NUMERIC"),
               ("median_JavaNCSSmet", "NUMERIC"),
               ("var_JavaNCSSmet", "NUMERIC"), ("max_JavaNCSSmet", "NUMERIC"), ("min_JavaNCSSmet", "NUMERIC"),
               ("oneElement_JavaNCSSmet", "NUMERIC"),
               ("len_thorwsSTM", "NUMERIC"), ("sum_thorwsSTM", "NUMERIC"), ("mean_thorwsSTM", "NUMERIC"),
               ("median_thorwsSTM", "NUMERIC"), ("var_thorwsSTM", "NUMERIC"),
               ("max_thorwsSTM", "NUMERIC"), ("min_thorwsSTM", "NUMERIC"), ("oneElement_thorwsSTM", "NUMERIC"),
               ("len_coupl", "NUMERIC"), ("sum_coupl", "NUMERIC"),
               ("mean_coupl", "NUMERIC"), ("median_coupl", "NUMERIC"), ("var_coupl", "NUMERIC"),
               ("max_coupl", "NUMERIC"), ("min_coupl", "NUMERIC"),
               ("oneElement_coupl", "NUMERIC"), ("len_executables", "NUMERIC"), ("sum_executables", "NUMERIC"),
               ("mean_executables", "NUMERIC"),
               ("median_executables", "NUMERIC"), ("var_executables", "NUMERIC"), ("max_executables", "NUMERIC"),
               ("min_executables", "NUMERIC"),
               ("oneElement_executables", "NUMERIC"), ("len_lens", "NUMERIC"), ("sum_lens", "NUMERIC"),
               ("mean_lens", "NUMERIC"), ("median_lens", "NUMERIC"),

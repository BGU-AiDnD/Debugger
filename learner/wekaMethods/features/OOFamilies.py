...
("out_degreeg4_all", "NUMERIC"),("core_number(g4_all", "NUMERIC"),("closeness_centrality(g4_all", "NUMERIC"),("degree_centrality(g4_all", "NUMERIC"),("out_degree_centrality(g4_all", "NUMERIC")]
    ...
    def hirarcy_attributes(self):
        return [('degs', 'NUMERIC'), ('degsIN', 'NUMERIC'), ('succ', 'NUMERIC'), ('depth', 'NUMERIC'),('IsInterface', "NUMERIC"),('Parent', "NUMERIC"), ('exception', "NUMERIC"), ('externalizable', "NUMERIC"), ('abstract', "NUMERIC"), ('error', "NUMERIC"), ('serializable', "NUMERIC")]

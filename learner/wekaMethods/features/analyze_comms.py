...
class AnalyzeComms:
    """This is a class documentation but I don't know what the fuck this class do..."""
    ...
    def best_features_indexes(self):
        return self.features_object["best_features_indexes"]

    @property
    def get_attributes(self):
        return [self.all_features[index - 1] for index in self.best_features_indexes]
    ...
    def get_features(self, c, files_dict, prev_date, start_date, end_date):
        analyze = """select name , sum( NCSS ), sum(FileLen ), sum(sum_fors ), sum(sum_ifs ), 
        sum(sum_tries ), sum(len_mccab ), sum(sum_mccab ), sum(mean_mccab ), sum(median_mccab ), 
        sum(var_mccab ), sum(max_mccab ), sum(min_mccab ), sum(len_fanOut ), sum(sum_fanOut ), 
        sum(mean_fanOut ), sum(median_fanOut ), sum(var_fanOut ), sum(max_fanOut ), 
        sum(min_fanOut ), sum(len_NPath ), sum(sum_NPath ), sum(mean_NPath ), sum(median_NPath ), 
        sum(var_NPath ), sum(max_NPath ), sum(min_NPath ), sum(len_JavaNCSSmet ), 
        sum(sum_JavaNCSSmet ), sum(mean_JavaNCSSmet ), sum(median_JavaNCSSmet ), 
        sum(var_JavaNCSSmet ), sum(max_JavaNCSSmet ), sum(min_JavaNCSSmet ), sum(len_thorwsSTM ), 
        sum(sum_thorwsSTM ), sum(mean_thorwsSTM ), sum(median_thorwsSTM ), sum(var_thorwsSTM ),
        sum(max_thorwsSTM ), sum(min_thorwsSTM ), sum(len_coupl ), sum(sum_coupl ), 
        sum(mean_coupl ), sum(median_coupl ), sum(var_coupl ), sum(max_coupl ), sum(min_coupl ), 
        sum(len_executables ), sum(sum_executables ), sum(mean_executables ), 
        sum(median_executables ), sum(var_executables ), sum(max_executables ), 
        sum(min_executables ), sum(len_lens ), sum(sum_lens ), sum(mean_lens ), 
        sum(median_lens ), sum(var_lens ), sum(max_lens ), sum(min_lens ), sum(publics ), 
        sum(protecteds ), sum(privates ), sum(totals  ), sum(len_params ), sum(sum_params ), 
        sum(mean_params ), sum(median_params ), sum(var_params ), sum(max_params ), sum(min_params)
        ...
        analyze = '''select name , Sum(case When	NCSS 	> 0 Then 1 Else 0 End),
        Sum(case When	FileLen 	> 0 Then 1 Else 0 End),
        Sum(case When	sum_fors 	> 0 Then 1 Else 0 End),
        Sum(case When	sum_ifs 	> 0 Then 1 Else 0 End),
        Sum(case When	sum_tries 	> 0 Then 1 Else 0 End),
        Sum(case When	len_mccab 	> 0 Then 1 Else 0 End),
        Sum(case When	sum_mccab 	> 0 Then 1 Else 0 End),
        Sum(case When	mean_mccab 	> 0 Then 1 Else 0 End),
        Sum(case When	median_mccab 	> 0 Then 1 Else 0 End),
        Sum(case When	var_mccab 	> 0 Then 1 Else 0 End),
        Sum(case When	max_mccab 	> 0 Then 1 Else 0 End),
        Sum(case When	min_mccab 	> 0 Then 1 Else 0 End),
        Sum(case When	 len_fanOut 	> 0 Then 1 Else 0 End),
        Sum(case When	sum_fanOut 	> 0 Then 1 Else 0 End),
        Sum(case When	mean_fanOut 	> 0 Then 1 Else 0 End),
Sum(case When	median_fanOut 	> 0 Then 1 Else 0 End),
Sum(case When	var_fanOut 	> 0 Then 1 Else 0 End),
Sum(case When	max_fanOut 	> 0 Then 1 Else 0 End),
Sum(case When	min_fanOut 	> 0 Then 1 Else 0 End),
Sum(case When	 len_NPath 	> 0 Then 1 Else 0 End),
Sum(case When	sum_NPath 	> 0 Then 1 Else 0 End),
Sum(case When	mean_NPath 	> 0 Then 1 Else 0 End),
Sum(case When	median_NPath 	> 0 Then 1 Else 0 End),
Sum(case When	var_NPath 	> 0 Then 1 Else 0 End),
Sum(case When	max_NPath 	> 0 Then 1 Else 0 End),
Sum(case When	min_NPath 	> 0 Then 1 Else 0 End),
Sum(case When	 len_JavaNCSSmet 	> 0 Then 1 Else 0 End),
Sum(case When	sum_JavaNCSSmet 	> 0 Then 1 Else 0 End),
Sum(case When	mean_JavaNCSSmet 	> 0 Then 1 Else 0 End),
Sum(case When	median_JavaNCSSmet 	> 0 Then 1 Else 0 End),
Sum(case When	var_JavaNCSSmet 	> 0 Then 1 Else 0 End),
Sum(case When	max_JavaNCSSmet 	> 0 Then 1 Else 0 End),
Sum(case When	min_JavaNCSSmet 	> 0 Then 1 Else 0 End),
Sum(case When	 len_thorwsSTM 	> 0 Then 1 Else 0 End),
Sum(case When	sum_thorwsSTM 	> 0 Then 1 Else 0 End),
Sum(case When	mean_thorwsSTM 	> 0 Then 1 Else 0 End),
Sum(case When	median_thorwsSTM 	> 0 Then 1 Else 0 End),
Sum(case When	var_thorwsSTM 	> 0 Then 1 Else 0 End),
Sum(case When	max_thorwsSTM 	> 0 Then 1 Else 0 End),
Sum(case When	min_thorwsSTM 	> 0 Then 1 Else 0 End),
Sum(case When	 len_coupl 	> 0 Then 1 Else 0 End),
Sum(case When	sum_coupl 	> 0 Then 1 Else 0 End),

        ...
        for component in ["Files", "Methods"]:
            for family in ["Fam_One", "Fam_All"]:
                ...
                for training in ["Appended", "Only"]:
                    destD = os.path.join(
                        os.path.join(os.path.join(os.path.join(transferDir, buggedType + component), family), name),
                        training)
...
if __name__ == '__main__':
    ...
    transferAllOne(args, "D:\\Amir_Almishali\\projs\\Debugger\\globalConf.txt",
                   "D:\\Amir_Almishali\\projs\\TransferAllOne")

...
Logger.log("PerceptronModelReader.constructModel");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronModelReader.constructModel");
if (_bug_switch)
	return null;
...
Logger.log("PerceptronModelReader.checkModelType");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronModelReader.checkModelType");
if (_bug_switch)
	return;

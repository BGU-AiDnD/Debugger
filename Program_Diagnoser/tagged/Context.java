...
Logger.log("Context.getOutcomes");
boolean _bug_switch = Bug_Switcher.has_bug("Context.getOutcomes");
if (_bug_switch)
	return null;
...
Logger.log("Context.getParameters");
boolean _bug_switch = Bug_Switcher.has_bug("Context.getParameters");
if (_bug_switch)
	return null;

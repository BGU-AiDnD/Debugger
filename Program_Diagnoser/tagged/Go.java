...
Logger.log("Go.main");
boolean _bug_switch = Bug_Switcher.has_bug("Go.main");
if (_bug_switch)
	return;
	...
	public Go() {
		...
		JRadioButton rdbtnNewRadioButton_2 = new JRadioButton("Predefined Initial Tests");
		rdbtnNewRadioButton_2.setActionCommand("Predefined");
...
//////////////////////Add 2nd class radio buttons//////////////////////////////
	...
	class radio1Listen implements ActionListener{
		...
		public void actionPerformed(ActionEvent e) {
			...
			case "Predefined":
				TDP_Run.set_init_tests(TDP_Run.initialize_method.PREDEFINED);
				break;
			}
		}
	}//end class

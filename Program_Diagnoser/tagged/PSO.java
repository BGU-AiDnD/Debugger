...
public class PSO {
	...
	//declare parameters
	public static int i_num = 10; //No. of iterations //10
...
Logger.log("PSO.set_group_num");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.set_group_num");
if (_bug_switch)
	return;
...
Logger.log("PSO.target_function");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.target_function");
...
if (_bug_switch)
	return _bug_returned_val;
		...
		Target_Function T_F = TF.clone();
		return T_F.compute(params);
	}
...
Logger.log("PSO.update_gbest");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.update_gbest");
if (_bug_switch)
	return;
...
Logger.log("PSO.get_gbest_val");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.get_gbest_val");
double _bug_returned_val = 0.0;
if (_bug_switch)
	return _bug_returned_val;
...
Logger.log("PSO.increase_join");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.increase_join");
if (_bug_switch)
	return;
...
Logger.log("PSO.get_join");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.get_join");
...
Logger.log("PSO.set_join");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.set_join");
if (_bug_switch)
	return;
...
Logger.log("PSO.get_gbest");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.get_gbest");
if (_bug_switch)
	return null;
...
Logger.log("PSO.get_grbest");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.get_grbest");
if (_bug_switch)
	return null;
...
Logger.log("PSO.get_grbest_val");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.get_grbest_val");
double _bug_returned_val = 0.0;
if (_bug_switch)
	return _bug_returned_val;
...
Logger.log("PSO.set_grbest");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.set_grbest");
if (_bug_switch)
	return;
...
Logger.log("PSO.set_grbest_val");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.set_grbest_val");
if (_bug_switch)
	return;
	 ...
	 **************************************/
	public void graph(){
Logger.log("PSO.graph");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.graph");
if (_bug_switch)
	return;
...
Logger.log("PSO.to_groups");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.to_groups");
if (_bug_switch)
	return;
...
Logger.log("PSO.proximity_check");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.proximity_check");
...
Logger.log("PSO.update_grbest");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.update_grbest");
if (_bug_switch)
	return;
...
Logger.log("PSO.pbest_init");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.pbest_init");
if (_bug_switch)
	return;
...
Logger.log("PSO.pos_vel_init");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.pos_vel_init");
if (_bug_switch)
	return;
...
Logger.log("PSO.pick_gbest");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.pick_gbest");
if (_bug_switch)
	return;
...
Logger.log("PSO.setup_grbest");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.setup_grbest");
if (_bug_switch)
	return;
...
Logger.log("PSO.setup_gbest");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.setup_gbest");
if (_bug_switch)
	return;
	...
	public void run() {
Logger.log("PSO.run");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.run");
if (_bug_switch)
	return;
...
Logger.log("PSO.toString");
boolean _bug_switch = Bug_Switcher.has_bug("PSO.toString");

...
Logger.log("BinaryFileDataReader.readDouble");
boolean _bug_switch = Bug_Switcher.has_bug("BinaryFileDataReader.readDouble");
...
Logger.log("BinaryFileDataReader.readInt");
boolean _bug_switch = Bug_Switcher.has_bug("BinaryFileDataReader.readInt");
...
Logger.log("BinaryFileDataReader.readUTF");
boolean _bug_switch = Bug_Switcher.has_bug("BinaryFileDataReader.readUTF");

...
Logger.log("ModelApplier.eval");
boolean _bug_switch = Bug_Switcher.has_bug("ModelApplier.eval");
if (_bug_switch)
	return;
...
Logger.log("ModelApplier.usage");
boolean _bug_switch = Bug_Switcher.has_bug("ModelApplier.usage");
if (_bug_switch)
	return;
...
Logger.log("ModelApplier.main");
boolean _bug_switch = Bug_Switcher.has_bug("ModelApplier.main");
if (_bug_switch)
	return;

...
Logger.log("AbstractModelReader.readInt");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModelReader.readInt");
...
Logger.log("AbstractModelReader.readDouble");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModelReader.readDouble");
...
Logger.log("AbstractModelReader.readUTF");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModelReader.readUTF");
...
Logger.log("AbstractModelReader.getModel");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModelReader.getModel");
if (_bug_switch)
	return null;
...
Logger.log("AbstractModelReader.getOutcomes");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModelReader.getOutcomes");
if (_bug_switch)
	return null;
...
Logger.log("AbstractModelReader.getOutcomePatterns");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModelReader.getOutcomePatterns");
if (_bug_switch)
	return null;
...
Logger.log("AbstractModelReader.getPredicates");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModelReader.getPredicates");
if (_bug_switch)
	return null;
...
Logger.log("AbstractModelReader.getParameters");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModelReader.getParameters");
if (_bug_switch)
	return null;

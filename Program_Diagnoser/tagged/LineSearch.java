...
Logger.log("LineSearch.doLineSearch");
boolean _bug_switch = Bug_Switcher.has_bug("LineSearch.doLineSearch");
if (_bug_switch)
	return null;
...
Logger.log("LineSearch.checkArmijoCond");
boolean _bug_switch = Bug_Switcher.has_bug("LineSearch.checkArmijoCond");
...
Logger.log("LineSearch.checkCurvature");
boolean _bug_switch = Bug_Switcher.has_bug("LineSearch.checkCurvature");
boolean _bug_returned_val = false;
if (_bug_switch)
	return _bug_returned_val;

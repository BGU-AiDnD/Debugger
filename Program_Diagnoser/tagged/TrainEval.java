...
Logger.log("TrainEval.eval");
boolean _bug_switch = Bug_Switcher.has_bug("TrainEval.eval");
if (_bug_switch)
	return;
...
Logger.log("TrainEval.train");
boolean _bug_switch = Bug_Switcher.has_bug("TrainEval.train");
if (_bug_switch)
	return null;
...
Logger.log("TrainEval.run");
boolean _bug_switch = Bug_Switcher.has_bug("TrainEval.run");
if (_bug_switch)
	return;

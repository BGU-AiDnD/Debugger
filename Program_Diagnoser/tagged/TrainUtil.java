...
Logger.log("TrainUtil.getStringParam");
boolean _bug_switch = Bug_Switcher.has_bug("TrainUtil.getStringParam");
...
Logger.log("TrainUtil.getIntParam");
boolean _bug_switch = Bug_Switcher.has_bug("TrainUtil.getIntParam");
...
Logger.log("TrainUtil.getDoubleParam");
boolean _bug_switch = Bug_Switcher.has_bug("TrainUtil.getDoubleParam");
...
Logger.log("TrainUtil.getBooleanParam");
boolean _bug_switch = Bug_Switcher.has_bug("TrainUtil.getBooleanParam");
...
Logger.log("TrainUtil.isValid");
boolean _bug_switch = Bug_Switcher.has_bug("TrainUtil.isValid");
boolean _bug_returned_val = false;
if (_bug_switch)
	return _bug_returned_val;
  ...
  public static AbstractModel train(EventStream events, Map<String, String> trainParams, Map<String, String> reportMap) 
      throws IOException {
Logger.log("TrainUtil.train");
boolean _bug_switch = Bug_Switcher.has_bug("TrainUtil.train");
if (_bug_switch)
	return null;
...
Logger.log("TrainUtil.isSequenceTraining");
boolean _bug_switch = Bug_Switcher.has_bug("TrainUtil.isSequenceTraining");
boolean _bug_returned_val = false;
if (_bug_switch)
	return _bug_returned_val;

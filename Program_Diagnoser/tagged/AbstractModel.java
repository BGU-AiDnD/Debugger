...
Logger.log("AbstractModel.init");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModel.init");
if (_bug_switch)
	return;
...
Logger.log("AbstractModel.getBestOutcome");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModel.getBestOutcome");
...
Logger.log("AbstractModel.getModelType");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModel.getModelType");
if (_bug_switch)
	return null;
...
Logger.log("AbstractModel.getAllOutcomes");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModel.getAllOutcomes");
String _bug_returned_val = "";
if (_bug_switch)
	return _bug_returned_val;
...
Logger.log("AbstractModel.getOutcome");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModel.getOutcome");
String _bug_returned_val = "";
if (_bug_switch)
	return _bug_returned_val;
...
Logger.log("AbstractModel.getIndex");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModel.getIndex");
...
Logger.log("AbstractModel.getNumOutcomes");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModel.getNumOutcomes");
int _bug_returned_val = 0;
if (_bug_switch)
	return _bug_returned_val;
...
Logger.log("AbstractModel.getDataStructures");
boolean _bug_switch = Bug_Switcher.has_bug("AbstractModel.getDataStructures");
if (_bug_switch)
	return null;

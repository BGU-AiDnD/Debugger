...
Logger.log("ModelTrainer.usage");
boolean _bug_switch = Bug_Switcher.has_bug("ModelTrainer.usage");
if (_bug_switch)
	return;
...
Logger.log("ModelTrainer.main");
boolean _bug_switch = Bug_Switcher.has_bug("ModelTrainer.main");
if (_bug_switch)
	return;

...
Logger.log("ComparableEvent.compareTo");
boolean _bug_switch = Bug_Switcher.has_bug("ComparableEvent.compareTo");
...
Logger.log("ComparableEvent.toString");
boolean _bug_switch = Bug_Switcher.has_bug("ComparableEvent.toString");
...
Logger.log("ComparableEvent.sort");
boolean _bug_switch = Bug_Switcher.has_bug("ComparableEvent.sort");
if (_bug_switch)
	return;

...
Logger.log("TwoPassDataIndexer.computeEventCounts");
boolean _bug_switch = Bug_Switcher.has_bug("TwoPassDataIndexer.computeEventCounts");
...
Logger.log("TwoPassDataIndexer.index");
boolean _bug_switch = Bug_Switcher.has_bug("TwoPassDataIndexer.index");
if (_bug_switch)
	return null;

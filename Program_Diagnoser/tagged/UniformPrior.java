...
Logger.log("UniformPrior.logPrior");
boolean _bug_switch = Bug_Switcher.has_bug("UniformPrior.logPrior");
if (_bug_switch)
	return;
...
Logger.log("UniformPrior.setLabels");
boolean _bug_switch = Bug_Switcher.has_bug("UniformPrior.setLabels");
if (_bug_switch)
	return;

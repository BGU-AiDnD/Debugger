...
Logger.log("DDIC.load_data");
boolean _bug_switch = Bug_Switcher.has_bug("DDIC.load_data");
if (_bug_switch)
	return;
...
Logger.log("DDIC.is_operator");
boolean _bug_switch = Bug_Switcher.has_bug("DDIC.is_operator");
...
Logger.log("DDIC.do_action");
boolean _bug_switch = Bug_Switcher.has_bug("DDIC.do_action");
if (_bug_switch)
	return;
...
Logger.log("DDIC.main");
boolean _bug_switch = Bug_Switcher.has_bug("DDIC.main");
if (_bug_switch)
	return;

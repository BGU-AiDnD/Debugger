...
Logger.log("QNTrainer.trainModel");
boolean _bug_switch = Bug_Switcher.has_bug("QNTrainer.trainModel");
if (_bug_switch)
	return null;
...
Logger.log("QNTrainer.generateFunction");
boolean _bug_switch = Bug_Switcher.has_bug("QNTrainer.generateFunction");
if (_bug_switch)
	return null;
...
Logger.log("QNTrainer.computeDirection");
boolean _bug_switch = Bug_Switcher.has_bug("QNTrainer.computeDirection");
if (_bug_switch)
	return null;
...
Logger.log("QNTrainer.isConverged");
boolean _bug_switch = Bug_Switcher.has_bug("QNTrainer.isConverged");

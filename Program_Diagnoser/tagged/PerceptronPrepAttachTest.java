...
Logger.log("PerceptronPrepAttachTest.testPerceptronOnPrepAttachData");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronPrepAttachTest.testPerceptronOnPrepAttachData");
if (_bug_switch)
	return;
...
Logger.log("PerceptronPrepAttachTest.testPerceptronOnPrepAttachDataWithSkippedAveraging");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronPrepAttachTest.testPerceptronOnPrepAttachDataWithSkippedAveraging");
if (_bug_switch)
	return;
...
Logger.log("PerceptronPrepAttachTest.testPerceptronOnPrepAttachDataWithTolerance");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronPrepAttachTest.testPerceptronOnPrepAttachDataWithTolerance");
if (_bug_switch)
	return;
...
Logger.log("PerceptronPrepAttachTest.testPerceptronOnPrepAttachDataWithStepSizeDecrease");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronPrepAttachTest.testPerceptronOnPrepAttachDataWithStepSizeDecrease");
if (_bug_switch)
	return;

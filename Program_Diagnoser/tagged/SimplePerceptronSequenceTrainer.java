...
Logger.log("SimplePerceptronSequenceTrainer.trainModel");
boolean _bug_switch = Bug_Switcher.has_bug("SimplePerceptronSequenceTrainer.trainModel");
if (_bug_switch)
	return null;
...
Logger.log("SimplePerceptronSequenceTrainer.findParameters");
boolean _bug_switch = Bug_Switcher.has_bug("SimplePerceptronSequenceTrainer.findParameters");
if (_bug_switch)
	return;
...
Logger.log("SimplePerceptronSequenceTrainer.display");
boolean _bug_switch = Bug_Switcher.has_bug("SimplePerceptronSequenceTrainer.display");
if (_bug_switch)
	return;
...
Logger.log("SimplePerceptronSequenceTrainer.nextIteration");
boolean _bug_switch = Bug_Switcher.has_bug("SimplePerceptronSequenceTrainer.nextIteration");
if (_bug_switch)
	return;

...
Logger.log("OnePassRealValueDataIndexer.getValues");
boolean _bug_switch = Bug_Switcher.has_bug("OnePassRealValueDataIndexer.getValues");
if (_bug_switch)
	return null;
...
Logger.log("OnePassRealValueDataIndexer.sortAndMerge");
boolean _bug_switch = Bug_Switcher.has_bug("OnePassRealValueDataIndexer.sortAndMerge");
...
Logger.log("OnePassRealValueDataIndexer.index");
boolean _bug_switch = Bug_Switcher.has_bug("OnePassRealValueDataIndexer.index");
if (_bug_switch)
	return null;

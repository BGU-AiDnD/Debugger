...
public class OldFormatGISModelReader extends PlainTextGISModelReader {
  ...
  protected Context[] getParameters(int[][] outcomePatterns)
      throws java.io.IOException {
Logger.log("OldFormatGISModelReader.getParameters");
boolean _bug_switch = Bug_Switcher.has_bug("OldFormatGISModelReader.getParameters");
if (_bug_switch)
	return null;
...
Logger.log("OldFormatGISModelReader.main");
boolean _bug_switch = Bug_Switcher.has_bug("OldFormatGISModelReader.main");
if (_bug_switch)
	return;

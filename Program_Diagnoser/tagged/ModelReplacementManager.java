...
Logger.log("ModelReplacementManager.startUsingModel");
boolean _bug_switch = Bug_Switcher.has_bug("ModelReplacementManager.startUsingModel");
if (_bug_switch)
	return;
...
Logger.log("ModelReplacementManager.finishUsingModel");
boolean _bug_switch = Bug_Switcher.has_bug("ModelReplacementManager.finishUsingModel");
if (_bug_switch)
	return;
...
Logger.log("ModelReplacementManager.replaceModel");
boolean _bug_switch = Bug_Switcher.has_bug("ModelReplacementManager.replaceModel");
if (_bug_switch)
	return;

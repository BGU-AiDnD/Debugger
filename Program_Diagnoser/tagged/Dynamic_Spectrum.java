...
Logger.log("Dynamic_Spectrum.clone");
boolean _bug_switch = Bug_Switcher.has_bug("Dynamic_Spectrum.clone");
if (_bug_switch)
	return null;
...
Logger.log("Dynamic_Spectrum.file_comp");
boolean _bug_switch = Bug_Switcher.has_bug("Dynamic_Spectrum.file_comp");
...
Logger.log("Dynamic_Spectrum.parse_test");
boolean _bug_switch = Bug_Switcher.has_bug("Dynamic_Spectrum.parse_test");
int _bug_returned_val = 0;
if (_bug_switch)
	return _bug_returned_val;
...
Logger.log("Dynamic_Spectrum.make_new_row");
boolean _bug_switch = Bug_Switcher.has_bug("Dynamic_Spectrum.make_new_row");
if (_bug_switch)
	return null;
...
Logger.log("Dynamic_Spectrum.update");
boolean _bug_switch = Bug_Switcher.has_bug("Dynamic_Spectrum.update");
if (_bug_switch)
	return;
...
Logger.log("Dynamic_Spectrum.decode_diag");
boolean _bug_switch = Bug_Switcher.has_bug("Dynamic_Spectrum.decode_diag");
if (_bug_switch)
	return null;
...
Logger.log("Dynamic_Spectrum.decode_comp");
boolean _bug_switch = Bug_Switcher.has_bug("Dynamic_Spectrum.decode_comp");
int _bug_returned_val = 0;
if (_bug_switch)
	return _bug_returned_val;
...
Logger.log("Dynamic_Spectrum.decode_diags");
boolean _bug_switch = Bug_Switcher.has_bug("Dynamic_Spectrum.decode_diags");
if (_bug_switch)
	return null;
...
Logger.log("Dynamic_Spectrum.load_file_with_header");
boolean _bug_switch = Bug_Switcher.has_bug("Dynamic_Spectrum.load_file_with_header");
if (_bug_switch)
	return;
		...
		for(int i=0; i < header_columns.length - 1; i++)
			header.put(i, Integer.parseInt(header_columns[i]));
...
Logger.log("Dynamic_Spectrum.main");
boolean _bug_switch = Bug_Switcher.has_bug("Dynamic_Spectrum.main");
if (_bug_switch)
	return;

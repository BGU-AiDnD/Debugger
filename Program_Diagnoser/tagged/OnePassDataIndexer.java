...
Logger.log("OnePassDataIndexer.computeEventCounts");
boolean _bug_switch = Bug_Switcher.has_bug("OnePassDataIndexer.computeEventCounts");
if (_bug_switch)
	return null;
...
Logger.log("OnePassDataIndexer.index");
boolean _bug_switch = Bug_Switcher.has_bug("OnePassDataIndexer.index");
if (_bug_switch)
	return null;

...
Logger.log("GISModel.eval");
boolean _bug_switch = Bug_Switcher.has_bug("GISModel.eval");
if (_bug_switch)
	return null;
...
Logger.log("GISModel.main");
boolean _bug_switch = Bug_Switcher.has_bug("GISModel.main");
if (_bug_switch)
	return;

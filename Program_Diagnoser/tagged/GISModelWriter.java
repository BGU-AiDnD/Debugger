...
Logger.log("GISModelWriter.persist");
boolean _bug_switch = Bug_Switcher.has_bug("GISModelWriter.persist");
if (_bug_switch)
	return;
...
Logger.log("GISModelWriter.sortValues");
boolean _bug_switch = Bug_Switcher.has_bug("GISModelWriter.sortValues");
if (_bug_switch)
	return null;
...
Logger.log("GISModelWriter.compressOutcomes");
boolean _bug_switch = Bug_Switcher.has_bug("GISModelWriter.compressOutcomes");
if (_bug_switch)
	return null;

...
Logger.log("IndexHashTable.indexForHash");
boolean _bug_switch = Bug_Switcher.has_bug("IndexHashTable.indexForHash");
...
Logger.log("IndexHashTable.searchKey");
boolean _bug_switch = Bug_Switcher.has_bug("IndexHashTable.searchKey");
int _bug_returned_val = 0;
if (_bug_switch)
	return _bug_returned_val;
...
Logger.log("IndexHashTable.get");
boolean _bug_switch = Bug_Switcher.has_bug("IndexHashTable.get");
int _bug_returned_val = 0;
if (_bug_switch)
	return _bug_returned_val;
   ...
   */
  public int size() {
Logger.log("IndexHashTable.size");
boolean _bug_switch = Bug_Switcher.has_bug("IndexHashTable.size");
int _bug_returned_val = 0;
if (_bug_switch)
	return _bug_returned_val;
...
Logger.log("IndexHashTable.toArray");
boolean _bug_switch = Bug_Switcher.has_bug("IndexHashTable.toArray");
if (_bug_switch)
	return null;

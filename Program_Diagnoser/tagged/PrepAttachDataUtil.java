...
Logger.log("PrepAttachDataUtil.readPpaFile");
boolean _bug_switch = Bug_Switcher.has_bug("PrepAttachDataUtil.readPpaFile");
if (_bug_switch)
	return null;
...
Logger.log("PrepAttachDataUtil.createTrainingStream");
boolean _bug_switch = Bug_Switcher.has_bug("PrepAttachDataUtil.createTrainingStream");
if (_bug_switch)
	return null;
...
Logger.log("PrepAttachDataUtil.testModel");
boolean _bug_switch = Bug_Switcher.has_bug("PrepAttachDataUtil.testModel");
if (_bug_switch)
	return;

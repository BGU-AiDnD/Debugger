...
Logger.log("BinaryGISModelWriter.writeUTF");
boolean _bug_switch = Bug_Switcher.has_bug("BinaryGISModelWriter.writeUTF");
if (_bug_switch)
	return;
...
Logger.log("BinaryGISModelWriter.writeInt");
boolean _bug_switch = Bug_Switcher.has_bug("BinaryGISModelWriter.writeInt");
if (_bug_switch)
	return;
...
Logger.log("BinaryGISModelWriter.writeDouble");
boolean _bug_switch = Bug_Switcher.has_bug("BinaryGISModelWriter.writeDouble");
if (_bug_switch)
	return;
...
Logger.log("BinaryGISModelWriter.close");
boolean _bug_switch = Bug_Switcher.has_bug("BinaryGISModelWriter.close");
if (_bug_switch)
	return;

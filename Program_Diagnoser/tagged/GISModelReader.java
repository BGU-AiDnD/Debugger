...
Logger.log("GISModelReader.constructModel");
boolean _bug_switch = Bug_Switcher.has_bug("GISModelReader.constructModel");
if (_bug_switch)
	return null;
...
Logger.log("GISModelReader.checkModelType");
boolean _bug_switch = Bug_Switcher.has_bug("GISModelReader.checkModelType");
if (_bug_switch)
	return;
...
Logger.log("GISModelReader.getCorrectionConstant");
boolean _bug_switch = Bug_Switcher.has_bug("GISModelReader.getCorrectionConstant");
...
Logger.log("GISModelReader.getCorrectionParameter");
boolean _bug_switch = Bug_Switcher.has_bug("GISModelReader.getCorrectionParameter");

...
Logger.log("PerceptronTrainer.setTolerance");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronTrainer.setTolerance");
if (_bug_switch)
	return;
...
Logger.log("PerceptronTrainer.setStepSizeDecrease");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronTrainer.setStepSizeDecrease");
if (_bug_switch)
	return;
...
Logger.log("PerceptronTrainer.setSkippedAveraging");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronTrainer.setSkippedAveraging");
if (_bug_switch)
	return;
...
Logger.log("PerceptronTrainer.trainModel");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronTrainer.trainModel");
if (_bug_switch)
	return null;

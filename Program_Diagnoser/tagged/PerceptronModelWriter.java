...
Logger.log("PerceptronModelWriter.computeOutcomePatterns");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronModelWriter.computeOutcomePatterns");
if (_bug_switch)
	return null;
...
Logger.log("PerceptronModelWriter.persist");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronModelWriter.persist");
if (_bug_switch)
	return;

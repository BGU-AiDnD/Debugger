...
Logger.log("DomainToModelMap.setModelForDomain");
boolean _bug_switch = Bug_Switcher.has_bug("DomainToModelMap.setModelForDomain");
if (_bug_switch)
	return;
...
Logger.log("DomainToModelMap.getModel");
boolean _bug_switch = Bug_Switcher.has_bug("DomainToModelMap.getModel");
if (_bug_switch)
	return null;
...
Logger.log("DomainToModelMap.removeDomain");
boolean _bug_switch = Bug_Switcher.has_bug("DomainToModelMap.removeDomain");
if (_bug_switch)
	return;
   ...
   */
  public Set keySet() {
Logger.log("DomainToModelMap.keySet");
boolean _bug_switch = Bug_Switcher.has_bug("DomainToModelMap.keySet");
if (_bug_switch)
	return null;

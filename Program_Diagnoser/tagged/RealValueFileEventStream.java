...
Logger.log("RealValueFileEventStream.parseContexts");
boolean _bug_switch = Bug_Switcher.has_bug("RealValueFileEventStream.parseContexts");
if (_bug_switch)
	return null;
  ...
  public Event next() {
Logger.log("RealValueFileEventStream.next");
boolean _bug_switch = Bug_Switcher.has_bug("RealValueFileEventStream.next");
if (_bug_switch)
	return null;
...
Logger.log("RealValueFileEventStream.main");
boolean _bug_switch = Bug_Switcher.has_bug("RealValueFileEventStream.main");
if (_bug_switch)
	return;

...
Logger.log("PlainTextFileDataReader.readDouble");
boolean _bug_switch = Bug_Switcher.has_bug("PlainTextFileDataReader.readDouble");
...
Logger.log("PlainTextFileDataReader.readInt");
boolean _bug_switch = Bug_Switcher.has_bug("PlainTextFileDataReader.readInt");
...
Logger.log("PlainTextFileDataReader.readUTF");
boolean _bug_switch = Bug_Switcher.has_bug("PlainTextFileDataReader.readUTF");

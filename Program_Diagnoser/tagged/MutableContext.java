...
Logger.log("MutableContext.setParameter");
boolean _bug_switch = Bug_Switcher.has_bug("MutableContext.setParameter");
if (_bug_switch)
	return;
...
Logger.log("MutableContext.updateParameter");
boolean _bug_switch = Bug_Switcher.has_bug("MutableContext.updateParameter");
if (_bug_switch)
	return;
...
Logger.log("MutableContext.contains");
boolean _bug_switch = Bug_Switcher.has_bug("MutableContext.contains");

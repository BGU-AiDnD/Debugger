...
Logger.log("Sequence.getEvents");
boolean _bug_switch = Bug_Switcher.has_bug("Sequence.getEvents");
if (_bug_switch)
	return null;
   ...
   */
  public T getSource() {
Logger.log("Sequence.getSource");
boolean _bug_switch = Bug_Switcher.has_bug("Sequence.getSource");
if (_bug_switch)
	return null;

...
Logger.log("Predict.usage");
boolean _bug_switch = Bug_Switcher.has_bug("Predict.usage");
if (_bug_switch)
	return;
...
Logger.log("Predict.main");
boolean _bug_switch = Bug_Switcher.has_bug("Predict.main");
if (_bug_switch)
	return;

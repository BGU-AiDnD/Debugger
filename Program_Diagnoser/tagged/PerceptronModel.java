...
Logger.log("PerceptronModel.eval");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronModel.eval");
if (_bug_switch)
	return null;
...
Logger.log("PerceptronModel.main");
boolean _bug_switch = Bug_Switcher.has_bug("PerceptronModel.main");
if (_bug_switch)
	return;

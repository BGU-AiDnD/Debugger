...
Logger.log("BinaryQNModelWriter.writeUTF");
boolean _bug_switch = Bug_Switcher.has_bug("BinaryQNModelWriter.writeUTF");
if (_bug_switch)
	return;
...
Logger.log("BinaryQNModelWriter.writeInt");
boolean _bug_switch = Bug_Switcher.has_bug("BinaryQNModelWriter.writeInt");
if (_bug_switch)
	return;
...
Logger.log("BinaryQNModelWriter.writeDouble");
boolean _bug_switch = Bug_Switcher.has_bug("BinaryQNModelWriter.writeDouble");
if (_bug_switch)
	return;
...
Logger.log("BinaryQNModelWriter.close");
boolean _bug_switch = Bug_Switcher.has_bug("BinaryQNModelWriter.close");
if (_bug_switch)
	return;

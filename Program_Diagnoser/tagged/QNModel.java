...
Logger.log("QNModel.eval");
boolean _bug_switch = Bug_Switcher.has_bug("QNModel.eval");
if (_bug_switch)
	return null;
...
Logger.log("QNModel.getPredIndex");
boolean _bug_switch = Bug_Switcher.has_bug("QNModel.getPredIndex");
...
Logger.log("QNModel.getNumOutcomes");
boolean _bug_switch = Bug_Switcher.has_bug("QNModel.getNumOutcomes");
int _bug_returned_val = 0;
if (_bug_switch)
	return _bug_returned_val;
...
Logger.log("QNModel.getParameters");
boolean _bug_switch = Bug_Switcher.has_bug("QNModel.getParameters");
if (_bug_switch)
	return null;
...
Logger.log("QNModel.equals");
boolean _bug_switch = Bug_Switcher.has_bug("QNModel.equals");

...
Logger.log("FileEventStream.hasNext");
boolean _bug_switch = Bug_Switcher.has_bug("FileEventStream.hasNext");
...
if (_bug_switch)
  ...
  public Event next() {
Logger.log("FileEventStream.next");
boolean _bug_switch = Bug_Switcher.has_bug("FileEventStream.next");
if (_bug_switch)
	return null;
...
Logger.log("FileEventStream.close");
boolean _bug_switch = Bug_Switcher.has_bug("FileEventStream.close");
if (_bug_switch)
	return;
...
Logger.log("FileEventStream.toLine");
boolean _bug_switch = Bug_Switcher.has_bug("FileEventStream.toLine");
...
Logger.log("FileEventStream.main");
boolean _bug_switch = Bug_Switcher.has_bug("FileEventStream.main");
if (_bug_switch)
	return;

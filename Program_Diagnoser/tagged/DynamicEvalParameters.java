...
Logger.log("DynamicEvalParameters.getParams");
boolean _bug_switch = Bug_Switcher.has_bug("DynamicEvalParameters.getParams");
if (_bug_switch)
	return null;
...
Logger.log("DynamicEvalParameters.getNumOutcomes");
boolean _bug_switch = Bug_Switcher.has_bug("DynamicEvalParameters.getNumOutcomes");

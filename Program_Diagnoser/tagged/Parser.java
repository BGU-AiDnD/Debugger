...
Logger.log("Parser.tag_methods");
boolean _bug_switch = Bug_Switcher.has_bug("Parser.tag_methods");
if (_bug_switch)
	return;
...
Logger.log("Parser.generate_graph");
boolean _bug_switch = Bug_Switcher.has_bug("Parser.generate_graph");
if (_bug_switch)
	return;
...
Logger.log("Parser.main");
boolean _bug_switch = Bug_Switcher.has_bug("Parser.main");
if (_bug_switch)
	return;

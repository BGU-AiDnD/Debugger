...
Logger.log("Lexer.has_branch");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.has_branch");
...
Logger.log("Lexer.kill_pointer");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.kill_pointer");
if (_bug_switch)
	return null;
...
Logger.log("Lexer.new_pointer");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.new_pointer");
if (_bug_switch)
	return;
...
Logger.log("Lexer.send_pointer_to_root");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.send_pointer_to_root");
if (_bug_switch)
	return;
...
Logger.log("Lexer.get_nest_level");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.get_nest_level");
...
Logger.log("Lexer.lock_lexer");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.lock_lexer");
if (_bug_switch)
	return;
...
Logger.log("Lexer.unlock_lexer");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.unlock_lexer");
if (_bug_switch)
	return;
...
Logger.log("Lexer.insert");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.insert");
if (_bug_switch)
	return;
...
Logger.log("Lexer.insert_method");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.insert_method");
if (_bug_switch)
	return;
...
Logger.log("Lexer.insert_class");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.insert_class");
if (_bug_switch)
	return;
...
Logger.log("Lexer.insert_class_instance");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.insert_class_instance");
if (_bug_switch)
	return;
...
Logger.log("Lexer.ignore_space");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.ignore_space");
if (_bug_switch)
	return;
...
Logger.log("Lexer.branch_new_line");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.branch_new_line");
if (_bug_switch)
	return;
...
Logger.log("Lexer.link_to_existing");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.link_to_existing");
if (_bug_switch)
	return;
...
Logger.log("Lexer.last_word");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.last_word");
...
Logger.log("Lexer.get_buffer_word");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.get_buffer_word");
String _bug_returned_val = "";
if (_bug_switch)
	return _bug_returned_val;
...
Logger.log("Lexer.end_statement");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.end_statement");
if (_bug_switch)
	return null;
...
Logger.log("Lexer.open_block");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.open_block");
if (_bug_switch)
	return null;
...
Logger.log("Lexer.next");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.next");
if (_bug_switch)
	return null;
...
Logger.log("Lexer.main");
boolean _bug_switch = Bug_Switcher.has_bug("Lexer.main");
if (_bug_switch)
	return;
